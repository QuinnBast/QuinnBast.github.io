...
fun Application.module() {
    ...
    install(Authentication) {
        ...
        session<OauthSession>("keycloak-session") {
            ...
            validate { session ->
                ...
                if (keycloakToken != null && keycloakToken.isActive) {
                    ...
                    // If the session is invalid, the user is redirected to the OAuth login page.
        ...
        oauth("keycloak") {
            ...
            urlProvider = { "https://localhost:9443/api/callback" }
    ...
    routing {
        ...
        route("/api") {
            post("/login") {
                ...
                if (user != null && userDatabase.verifyUser(login.username, login.password, login.otpGuess)) {
            ...
            authenticate("keycloak") {
                ...
                get("/callback") {
                    ...
                    call.sessions.set<OauthSession>(OauthSession(
                    ...
                    if(principal.state != null) {
                        ...
                        if(redirectMaybe != null) {
                            println("Redirecting to: $redirectMaybe")
            ...
            authenticate("keycloak-session") {
                ...
                get("/oauth-admin") {
                    val keycloakToken = call.sessions.get<OauthSession>()?.userSession()!!
                    if(keycloakToken.realmAccess.isUserInRole("admin")) {
                        call.respond(HttpStatusCode.OK, "You are an admin!")
                    } else {
