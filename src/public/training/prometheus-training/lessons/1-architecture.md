...
![Prometheus GUI](./images/PrometheusGui.png)
...
Take a look at the prometheus [config file](../config/prometheus.yml).
This file configures a `scrape_configs` section which tells prometheus to attempt to scrape `localhost:1234`.

![Failing Target](./images/PrometheusFailingTarget.png)
